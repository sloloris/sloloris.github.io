      ...
      <div>
        <div className='project-section'>
          ...
          <div className='see-linkedin'>
            For information on my educational background and work experience, please <a href='https://www.linkedin.com/in/isabelle-miller/' target='_blank'>see my LinkedIn</a> or <a href='/IMiller_resume.pdf' target="_blank">click here to download my résumé.</a>
