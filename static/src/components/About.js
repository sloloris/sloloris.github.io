    ...
    return(
      <div>
        ...
        <div className='about-text'>
          Hi, my name is Isabelle. I like to code, travel, write, bake, paint, and think about how tech can be harnessed to improve governance, social equality, and quality of life in the developing world. I prefer my coffee with milk and my cookies with chocolate.
          <br />
          <br />
